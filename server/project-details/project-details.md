...
Personal freeroam MTA:SA server focused on fun, experimentation, content creation, and multiplayer gameplay with friends. Public release is optional if development reaches a stable state.
...
- Validate inventory, money, and permissions server side
- Validate all remote event data
