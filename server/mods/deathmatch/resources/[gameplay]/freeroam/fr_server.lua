...
local function getResponsiblePlayer(attacker)
	if not isElement(attacker) then return nil end
	if getElementType(attacker) == "player" then return attacker end
	if getElementType(attacker) == "vehicle" then return getVehicleController(attacker) end
	return nil
end
...
addEventHandler("onPedDamage", root,
	function(attacker)
